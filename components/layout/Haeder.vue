    ...
    <div class="nav">
      <el-row type="flex" justify="space-between">
        ...
        <el-col :xs="4" :sm="4" :md="4" class="logo">
          <nuxt-link to="/"><img src="@/assets/images/logo.png" alt="logo" height="40px"></nuxt-link>
        </el-col>
        ...
        <el-col class="hidden-sm-and-down" :md="10">
          <el-menu mode="horizontal" router default-active="/" background-color="#fafafa" active-text-color="#345dc2">
...
<style lang="scss" scoped>
  ...
  .el-menu.el-menu--horizontal { /* 去除底部边框 */
    border-bottom: 0;
    margin-top: -0.625rem;
  }
